...
namespace Stats.FishNet
{
    public static class StatNumberSerializer
    {
        ...
        public static void WriteTDouble(this Writer writer, TDouble value) => writer.WriteDouble(value);
        public static TDouble ReadTDouble(this Reader reader) => reader.ReadDouble();
    }
}